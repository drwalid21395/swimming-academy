...
function seed() {
  ...
  const revData = [
    ['REV-2026-0001', 'اشتراكات اللاعبين', 'اشتراكات شهر أغسطس', 18500, 'نقدي', 'اشتراكات متنوعة'],
    ...
    ['REV-2026-0005', 'اشتراكات اللاعبين', 'تجديدات منتصف الشهر', 7400, 'نقدي', '']
  ];
  ...
  ins('faqs', { question: 'ما المستندات المطلوبة للتسجيل؟', answer: 'صورة شهادة ميلاد اللاعب، صورة بطاقة ولي الأمر، إقرار حالة صحية موقّع.', order_index: 4 });
