...
async function getAcademy(academyId) {
  return cached('academy:' + Number(academyId), async () => {
...
async function getActiveSubscription(academyId) {
  return cached('academy-subscription:' + Number(academyId), async () => {
    try {
...
async function academyPlanPerms(academyId) {
  return cached('academy-plan-perms:' + Number(academyId), async () => {
