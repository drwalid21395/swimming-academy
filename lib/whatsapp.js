...
function buildReceiptMessage(o) {
  ...
  lines.push('السباح: ' + (o.swimmerName || '—'));
...
module.exports = { normalizePhone, waLink, waLinkFor, buildRenewalMessage, buildReceiptMessage, sendViaApi, sendReminder, logMessage, maybeSendExpiryReminders };