...
function buildReceiptMessage(o) {
  ...
  if (o.subscriptionType === 'per_session' || o.subscriptionType === 'one_time') {
    lines.push('نوع الاشتراك: ' + (o.subscriptionType === 'one_time' ? 'لمرة واحدة' : 'بالحصة'));
    lines.push('سعر الحصة: ' + fmt(o.pricePerSession));
    if (o.sessionsTotal !== undefined) lines.push('الحصص المتبقية: ' + Math.max(0, Number(o.sessionsTotal || 0) - Number(o.sessionsUsed || 0)));
  }
  lines.push('──────────────');
