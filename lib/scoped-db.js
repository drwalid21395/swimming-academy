...
const ALWAYS_SHARED = new Set(['plans', 'academies', 'academy_subscriptions', 'payments_history', 'payment_requests', 'settings', 'audit_log', 'password_reset_requests', 'sqlite_sequence', 'roles', 'sports']);
